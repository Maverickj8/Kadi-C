...
const products = [
  ...
  },
  {
    id: "kola-nuts",
    title: "Kola Nuts",
    subtitle: "Kola Nuts Export",
    detailTitle: "Kola Nuts Supply & Export From Nigeria",
    detailSubtitle: "We are kola nuts exporters in Nigeria",
    description:
      "We supply quality kola nuts to global markets.Kola nut is a bitter, caffeine-rich seed from the kola tree (Cola acuminata or Cola nitida), native to West and Central Africa. For centuries, it has held deep cultural, social, and economic importance across many African communities. Beyond its traditional uses, kola nut is also a key ingredient in the original formulas of many cola drinks.",
    specifications: {
      origin: "Nigeria",
      type: "Dried Kola Nuts",
      price: "Negotiable per kg/Ton",
    },
  },
  {
    ...
    detailTitle: "Cocoa beans Supply & Export From Nigeria",
    detailSubtitle: "We are Cocoa beans exporters in Nigeria",
    description:
      "We supply quality Cocoa beans for various industrial uses.Cocoa beans are the dried, fermented seeds of the cacao tree (Theobroma cacao), the tropical plant that gives the world chocolate. They are one of the most valuable agricultural commodities globally and are grown mainly in West Africa, Latin America, and Southeast Asia.",
    specifications: {
      origin: "Nigeria",
      type: "Cocoa beans",
      price: "Negotiable per kg/Ton",
  ...
  },
  {
    id: "Palm Oil",
    title: "Palm Oil",
    subtitle: "Palm Oil Export",
    detailTitle: "Palm Oil Supply & Export From Nigeria",
    detailSubtitle: "We are Palm Oil oil exporters in Nigeria",
    description:
      "We supply premium Palm Oil to global markets. Palm oil is a rich, reddish-gold vegetable oil extracted from the fruit of the oil palm tree (Elaeis guineensis), a tropical species native to West Africa but now cultivated widely in Asia and parts of South America. It is one of the most widely used oils in the world, valued for its flavor, stability, and versatility.",
    specifications: {
      origin: "Nigeria",
      type: "Crude and Refined Palm Oil",
      price: "Negotiable per kg/Ton",
    },
  },
  {
    ...
    subtitle: "Hard wood charcoal",
    detailTitle: "Hard wood charcoal Supply & Export From Nigeria",
    detailSubtitle: "We are Hard wood charcoal exporters in Nigeria",
    description:
      "We supply quality Hard wood charcoal for various applications.Hardwood Charcoal is a type of charcoal made by slowly burning hardwood in the absence of oxygen (a process called pyrolysis). It is denser, harder, and produces more heat compared to softwood charcoal.",
    specifications: {
      origin: "Nigeria",
      type: "Hard wood charcoals",
      price: "Negotiable per kg/Ton",
    },
  },
  {
    id: "Oraganic Honey",
    title: "Oraganic Honey",
    subtitle: "Oraganic Honey Export",
    detailTitle: "Premium Oraganic Honey Supply & Export From Nigeria",
    detailSubtitle: "We are quality Oraganic Honey exporters in Nigeria",
    description:
      "We supply premium Oraganic Honey to chocolate manufacturers worldwide.Organic honey is honey from bees foraging on organically grown plants, free from synthetic pesticides, herbicides, GMOs, and chemical hive treatments, meeting strict certification standards for chemical-free, natural production, often raw and unprocessed, preserving more nutrients and antioxidants.",
    specifications: {
      origin: "Nigeria",
      type: "Oraganic Honey",
      price: "Negotiable per kg/Ton",
  ...
  },
  {
    id: "Bitter Kola",
    title: "Bitter Kola",
    subtitle: "Bitter Kola Export",
    detailTitle: "Bitter Kola Supply & Export From Nigeria",
    detailSubtitle: "We are Bitter Kola exporters in Nigeria",
    description:
      "We supply fresh Bitter Kola to global markets.Bitter kola, also known as Garcinia kola, is a highly valued African medicinal seed known for its sharp bitterness, strong aroma, and powerful health benefits. It has been used for generations across West and Central Africa in traditional medicine, cultural ceremonies, and everyday wellness.",
    specifications: {
      origin: "Nigeria",
...
function HomePage({ onProductClick }) {
  return (
    <div>
      {/* Hero Section */}
      <div className="relative bg-gradient-to-r from-gray-800 to-gray-900 text-white py-20 md:py-24 px-4">
        <div
