...
highest standards of global markets`,
    ...
    specifications: {
      origin: "Nigeria",
      type: "Premium Organic Honey (Raw / Unprocessed)",
      ...
      purity: "Minimum of 98% (Natural, chemical-free, no additives)",
      packaging:
        "Packed in 25kg food-grade plastic pails, 200–300kg food-grade drums, or glass jars as per buyer’s request, securely sealed for export.",
    },
  },
  {
    id: "ginger",
  ...
  },
  {
    ...
    description: "We supply quality tiger nuts to global markets. Tiger Nut (Premium Export Grade) Nigerian tiger nuts are premium-quality tubers grown in nutrient-rich soil and harvested under strict quality control. They are carefully cleaned, sorted, and dried to preserve their natural sweetness, crunchy texture, and nutritional value. Tiger nuts are rich in dietary fiber, healthy fats, vitamins, and minerals, making them ideal for direct consumption, milk production, flour processing, and health food applications. Our tiger nuts are free from stones, sand, and foreign matter, with excellent shelf stability when properly stored. They are packed in export-standard, food-grade packaging to meet international market requirements.",
    specifications: {
      origin: "Nigeria",
  ...
  },
  {
    ...
    description: "We supply quality soybeans for various industrial uses. Soya Beans (Non-GMO, Export Grade) Nigerian soya beans are high-quality, non-GMO agricultural products cultivated under favorable climatic conditions and carefully processed to meet international export standards. The beans are well-cleaned, uniformly sized, and free from stones, dust, and other foreign materials. They are rich in protein and oil, making them ideal for use in food processing, animal feed production, edible oil extraction, and industrial applications. Our soya beans are properly dried to ensure long shelf life, packed in food-grade materials, and supplied in bulk quantities to meet the demands of international buyers.",
    specifications: {
      origin: "Nigeria",
...
const productImages = {
  ...
  ginger: [
    "/images/products/ginger1.jpeg",
    "/images/products/ginger2.jpeg",
